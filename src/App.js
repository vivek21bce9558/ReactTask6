  ...
  return (
    <div className="App">
      ...
      <section className="about" id="about">
        ...
        <div className="row">
          <div className="info">
            <h3> <span> Name : </span>Vivek</h3>
            <h3> <span> Qualification : </span> B.Tech(pursuing) </h3>
            <h3> <span> Address</span> Markapuram</h3>
            <h3> <span> Strengths : </span> Hardwork,Dedication </h3>
            <h3> <span> Hobbies: </span>Reading Books, workouts</h3>
      ...
      <section className="education" id="education">
        ...
        <div className="box-container">
          <div className="box">
            ...
            <span>2018-2019</span>
            <h3>SSC</h3>
            <p style={{ fontSize: '20px' }}>Jawahar Navodaya vidyalaya 2</p>
          </div>
          <div className="box">
            <i className="fas fa-graduation-cap"></i>
            <span>2019-2021</span>
            <h3>Intermediate</h3>
            <h3>MPC</h3>
            <p style={{ fontSize: '20px' }}>Gurus vidyanikethan</p>
          </div>
          <div className="box">
            <i className="fas fa-graduation-cap"></i>
            <span>2021-2025</span>
      ...
      <section className="contact" id="contact">
        ...
        <div className="row">
          <div className="content">
            ...
            <div className="info">
              <h3> <i className="fas fa-envelope"></i> Vivek.21bce9558@vitapstudent.ac.in</h3>
              <h3> <i className="fas fa-phone"></i> 8367360711 </h3>
              <h3> <i className="fas fa-map-marker-alt"></i> Markapuram</h3>
            </div>
          </div>
        </div>
      </section>
